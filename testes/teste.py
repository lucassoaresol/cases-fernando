...
class Teste(unittest.TestCase):
    ...
    def teste_sem_nomes(self):
        self.ranking.define_titulo()
        self.ranking.gera_ranking()

        self.assertEqual(
            self.ranking.titulo + self.ranking.ranking,
            "Ranking geral dos nomes:\n1º - MARIA - 11734129\n2º - JOSE - 5754529\n3º - ANA - 3089858\n4º - JOAO - 2984119\n5º - ANTONIO - 2576348\n6º - FRANCISCO - 1772197\n7º - CARLOS - 1489191\n8º - PAULO - 1423262\n9º - PEDRO - 1219605\n10º - LUCAS - 1127310\n11º - LUIZ - 1107792\n12º - MARCOS - 1106165\n13º - LUIS - 935905\n14º - GABRIEL - 932449\n15º - RAFAEL - 821638\n16º - FRANCISCA - 725642\n17º - DANIEL - 711338\n18º - MARCELO - 693215\n19º - BRUNO - 668217\n20º - EDUARDO - 632664\n",
        )

    def teste_sem_nomes_com_localidades(self):
        self.ranking.define_titulo(localidades=self.localidades)
        self.ranking.gera_ranking(localidades=self.localidades)
    ...
    def teste_sem_nomes_com_localidades_e_sexo(self):
        self.ranking.define_titulo(localidades=self.localidades, sexo="M")
        self.ranking.gera_ranking(localidades=self.localidades, sexo="M")
    ...
    def teste_sem_nomes_com_localidades_sexo_e_decadas(self):
        self.ranking.define_titulo(
            localidades=self.localidades, decadas=self.decadas, sexo="M"
        )
        self.ranking.gera_ranking(
            localidades=self.localidades, decadas=self.decadas, sexo="M"
        )
    ...
    def teste_sem_nomes_com_sexo(self):
        self.ranking.define_titulo(sexo="F")
        self.ranking.gera_ranking(sexo="F")
    ...
    def teste_sem_nomes_com_sexo_e_decadas(self):
        self.ranking.define_titulo(sexo="M", decadas=self.decadas)
        self.ranking.gera_ranking(sexo="M", decadas=self.decadas)
    ...
    def teste_sem_nomes_com_decadas(self):
        self.ranking.define_titulo(decadas=self.decadas)
        self.ranking.gera_ranking(decadas=self.decadas)
    ...
    def teste_com_nomes(self):
        self.ranking.define_titulo(self.nomes)
        self.ranking.gera_ranking(self.nomes)
    ...
    def teste_com_nomes_e_localidades(self):
        self.ranking.define_titulo(self.nomes, localidades=self.localidades)
        self.ranking.gera_ranking(self.nomes, localidades=self.localidades)
    ...
    def teste_com_nomes_localidades_e_sexo(self):
        self.ranking.define_titulo(self.nomes_sexo, "F", self.localidades)
        self.ranking.gera_ranking(self.nomes_sexo, "F", self.localidades)
    ...
    def teste_com_nomes_e_sexo(self):
        self.ranking.define_titulo(self.nomes_sexo, "F")
        self.ranking.gera_ranking(self.nomes_sexo, "F")
    ...
    def teste_com_nomes_sexo_e_decadas(self):
        self.ranking.define_titulo(self.nomes_sexo, "M", decadas=self.decadas)
        self.ranking.gera_ranking(self.nomes_sexo, "M", decadas=self.decadas)
    ...
    def teste_com_nomes_e_decadas(self):
        self.ranking.define_titulo(self.nomes_sexo, decadas=self.decadas)
        self.ranking.gera_ranking(self.nomes_sexo, decadas=self.decadas)

...
class Teste(unittest.TestCase):
    ...
    def teste_com_nomes_localidades_sexo_e_decadas(self):
        ...
        localidades = ["11", "33"]
        decadas = ["1930", "1940"]
        nomes_frequencia = Item(self.api, nomes, "M").frequencia(localidades, decadas)
        self.assertEqual(
            ranking.nomes(nomes_frequencia),
    ...
    def teste_com_nomes_sexo_e_decadas(self):
        ...
        nomes = ["lucas", "pedro", "carlos", "maria"]
        decadas = ["1930", "1940"]
        nomes_frequencia = Item(self.api, nomes, "M").frequencia(decadas=decadas)
        self.assertEqual(
            ranking.nomes(nomes_frequencia),
    ...
    def teste_com_nomes_e_decadas(self):
        ...
        nomes = ["lucas", "pedro", "carlos", "maria"]
        decadas = ["1930", "1940"]
        nomes_frequencia = Item(self.api, nomes).frequencia(decadas=decadas)
        self.assertEqual(
            ranking.nomes(nomes_frequencia),
